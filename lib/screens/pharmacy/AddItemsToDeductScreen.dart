...
class _AddItemsToDeductScreenState extends State<AddItemsToDeductScreen> {
  ...
  void initState() {
    ...
    Provider.of<ShiftProvider>(context,listen: false).getDeductById(widget.deduct.id, context);
  }
              ...
              onPressed: () async {
                ...
                try {
                  ...
                  SocketService().sendMessage(
                      'update deduct', jsonEncode(deductDataAsJson));
                } catch (e) {
      ...
      body: Padding(
        ...
        child: Column(
          children: [
                ...
                return DropdownSearch<Client>(
                  ...
                  onChanged: (Client? data) async {
                    try {
                      ...
                      SocketService().sendMessage(
                          'update deduct', jsonEncode(json['data']));
                    } catch (e) {
                      throw Exception(e.toString());
                    }
                    // setState(() {
            ...
            MultiSelectDialogField<Item>(
              ...
              onConfirm: (values) async {
                final Deduct? _deduct = await context
                    .read<ShiftProvider>()
                    .saveDeductItems(values, widget.deduct, context);
                SocketService().sendMessage(
                    'update deduct', jsonEncode(_deduct!.toJson()));
            ...
            SizedBox(height: 5),
            Consumer<ShiftProvider>(builder: (context, shiftProvider, child) {
                ...
                ? ElevatedButton(
                    ...
                    onPressed: () async {
                      try {
                        ...
                        SocketService().sendMessage(
                            'update deduct', jsonEncode(response.data['data']));
                    ...
                    return Row(
                      ...
                      children: [
                        ElevatedButton(
                         ...
                         Text('Total ${NumberFormat().format(_selectedDedduct!.totalPrice ?? 0)}')
